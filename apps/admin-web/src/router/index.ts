...
import CounterPaymentNewView from "@/views/CounterPaymentNewView.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/counter/payments/new", name: "counter-payment-new", component: CounterPaymentNewView, meta: { requiresAuth: true, title: "Bayaran Kaunter" } },
