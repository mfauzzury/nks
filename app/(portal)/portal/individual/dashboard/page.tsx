    ...
    <PortalAuthGuard expected="individu">
      <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-[calc(100vh-6rem)] w-screen overflow-hidden portal-cosmic-bg py-6 md:py-8">
        ...
        <div className="mx-auto w-full max-w-6xl space-y-6 px-4 md:px-6">
          {session ? <PortalSubnav role="individu" session={session} variant="onDark" /> : null}
          ...
          <section className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-white/20 bg-white/12 p-5 backdrop-blur-md">
              ...
              <p className="mt-1 text-sm text-purple-200/70">Semua pembayaran zakat anda</p>
            </article>
            <article className="rounded-2xl border border-white/20 bg-white/12 p-5 backdrop-blur-md">
              <div className="flex items-center justify-between">
            ...
            <article className="rounded-2xl border border-white/20 bg-white/12 p-5 backdrop-blur-md">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-purple-100">Status Akaun</p>
                <UserRound className="h-4 w-4 text-purple-200" />
              </div>
