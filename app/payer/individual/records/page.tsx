    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Rekod Sumbangan</h1>
            <p className="text-sm text-muted-foreground">Sila log masuk untuk melihat rekod anda.</p>
          </div>
        </div>
        <section className="rounded-2xl border border-slate-200 bg-white p-6">
          <p className="text-sm text-slate-600">Akses rekod memerlukan sesi portal individu yang sah.</p>
          <div className="mt-4">
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Rekod Sumbangan</h1>
            <p className="text-sm text-muted-foreground">Semak transaksi berdasarkan IC log masuk: {identityNo}</p>
          </div>
        </div>
        <select
          value={filterYear}
